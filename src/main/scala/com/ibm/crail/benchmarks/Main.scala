...
object Main {
  ...
  def main(args : Array[String]) {
    ...
    if(subsystemOptions.withWarmup()){
      ...
      sb.append("WarmUp Execution time : " + Utils.twoLongDivToDecimal(e - s, Utils.MICROSEC) + " msec" + "\n")
    ...
    val e = System.nanoTime()
    val lapsedTimeInNanosec = e - s
    sb.append("-------------" + mainOptions.getSubsystem+":"+subsystemOptions.getTestName +" -------------" + "\n")
    sb.append("Test           : " + test.plainExplain() + "\n")
    sb.append("Execution time : " + Utils.twoLongDivToDecimal(lapsedTimeInNanosec, Utils.MICROSEC) + " msec" + "\n")
